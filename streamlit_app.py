...
def browse_folder():
    """Handle folder selection and state update."""
...
with col1:
    save_folder = st.text_input("Save folder path:", value=st.session_state['folder_path'])

with col2:
    # Add empty space to align with input field
